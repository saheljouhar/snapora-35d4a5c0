...
import { X, Download, Trash2, Users, Image as ImageIcon, BarChart3, Eye } from 'lucide-react';
...
const AdminDashboard = ({ uploadCount, onClose }: AdminDashboardProps) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl max-h-[90vh] overflow-hidden bg-white rounded-2xl shadow-2xl">
        ...
        <CardContent className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          {/* Device Analytics */}
          <div className="mt-8">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Device Statistics</h3>
